<template>
  <div class="vue-form-generator" v-if="schema != null">
    <pre style="display: none;">{{ schema }}</pre>
    <fieldset v-if="schema.fields" :is="tag">
      ...
      <div class="form-group valid disabled readonly field-input">
        <label for="id-disabled-text-field"><span>ID (disabled text field)</span> <!----></label>
        <div class="field-wrap">
          <div class="wrapper"><input id="id-disabled-text-field"
                                      type="text"
                                      disabled="disabled"
                                      readonly="readonly"
                                      class="form-control"><!----></div> <!----></div> <!----> <!----></div>
      <div class="form-group valid featured required field-input"><label for="name"><span>Name</span> <!----></label>
        <div class="field-wrap">
          <div class="wrapper"><input id="name"
                                      type="text"
                                      placeholder="Your name"
                                      required="required"
                                      class="form-control"><!----></div> <!----></div> <!----> <!----></div>
      <div class="form-group valid required field-input"><label for="password"><span>Password</span> <!----></label>
        <div class="field-wrap">
          <div class="wrapper"><input id="password"
                                      type="password"
                                      min="6"
                                      required="required"
                                      class="form-control"><!----></div> <!----></div>
        <div class="hint">Minimum 6 characters</div> <!----></div>
      <div class="form-group valid field-select"><label for="skills"><span>Skills</span> <!----></label>
        <div class="field-wrap"><select id="skills" class="form-control">
      ...
      <div class="form-group valid field-input"><label for="e-mail"><span>E-mail</span> <!----></label>
        <div class="field-wrap">
          <div class="wrapper"><input id="e-mail"
                                      type="email"
                                      placeholder="User's e-mail address"
                                      class="form-control"><!----></div> <!----></div> <!----> <!----></div>
      <div class="form-group valid field-checkbox"><label for="status"><span>Status</span> <!----></label>
        <div class="field-wrap"><input id="status" type="checkbox"> <!----></div> <!----> <!----></div>
    </fieldset>
  </div>
</template>
